...
namespace AppLanterna
{
    public partial class MainPage : ContentPage
    {
        ...
        public MainPage()
        {
            ...
            btnOnOff.Source = ImageSource.FromResource("AppLanterna.Botoes.botao_off.png");
        ...
        private async void btnOnOff_Clicked(object sender, EventArgs e)
        {
            try
            {
                if (!lanterna_ligada)
                {
                    ...
                    btnOnOff.Source = ImageSource.FromResource("AppLanterna.Botoes.botao_on.png");
        ...
        private async void Carrega_Informacoes_Bateria()
        {
            try
            {
                ...
                { 
                    ...
                    lbl_bateria_fraca.Text = "As Informações sobreabateria não estão disponíveis :(";
            }
            catch(Exception ex)
            {
                await DisplayAlert("Ocorreu um erro: \n", ex.Message ,"OK");
